...
class LMDataSet(torch.nn.Module):
    ...
    def setup(self, stage='fit'):
        ...
        datasets = load_dataset(extension, data_files=data_files, cache_dir=os.path.abspath(self.cache_dir))
            ...
            if self.max_seq_length is None:
                ...
                if self.max_seq_length > self.tokenizer.model_max_length:
                    warnings.warn(
                        ...
                        f"model ({self.tokenizer.model_max_length}). Using max_seq_length={tokenizer.model_max_length}."
                    )
