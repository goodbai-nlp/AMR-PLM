...
export OUTPUT_DIR_NAME=outputs/AMR17-bart-large-amr2text-bsz16-3e-5-init-noearly-beam${eval_beam}-leonard
export OUTPUT_DIR_NAME=outputs/AMR17-bart-large-amr2text-bsz16-2e-5-init-noearly-beam${eval_beam}-leonard
